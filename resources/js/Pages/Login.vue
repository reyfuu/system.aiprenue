        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-2xl shadow-2xl p-8">
                ...
                <div
                    ...
                    class="mb-4 bg-emerald-50 border border-emerald-200 text-emerald-800 text-sm px-4 py-2.5 rounded-xl"
                >
...
viewBox="0 0 24 24">
                                    <path
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
                                        d="M3 3l18 18M10.6 10.6a3 3 0 004.2 4.2M9.9 4.7A9.6 9.6 0 0112 4.5c6.5 0 9.5 6.5 9.5 6.5a15 15 0 01-3 3.9M6.1 6.1A15 15 0 002.5 11s3 6.5 9.5 6.5a9.3 9.3 0 003.4-.6"
                                    />
                                </svg>
                            </button>
                        </div>
                    ...
                    <div class="flex items-center">
                        <label class="flex items-center gap-2 text-sm text-slate-600">
                            <input v-model="form.remember" type="checkbox" class="accent-brand-600" /> Ingat saya
                        </label>
                    </div>
                ...
                <!-- Jalan masuk untuk yang belum punya akun -->
                <p class="text-center text-sm text-slate-500 mt-5">
                    Belum punya akun?
                    <Link href="/register" class="font-medium text-brand-600 hover:text-brand-800">Daftar</Link>
                </p>
            </div>
