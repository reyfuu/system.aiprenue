...
<template>
    ...
    <Layout title="User">
        ...
        <div class="px-6 py-6">
                        ...
                        <tr v-for="u in users" :key="u.id" class="hover:bg-brand-50/60 transition">
                            ...
                            <td class="px-4 py-2.5">
                                ...
                                <span
                                    :class="
                                        ...
                                        (roleColors[u.role] || 'bg-slate-200 text-slate-700')
                                    "
                                >
                                    {{ roles[u.role] || u.role }}
                                    <!-- label role -->
                            ...
                            <td class="px-4 py-2.5 text-center whitespace-nowrap">
                                ...
                                <div class="flex items-center justify-center gap-1.5">
                                    ...
                                    <!-- tombol edit -->
                                    <button
                                        class="bg-brand-600 hover:bg-brand-700 text-white text-xs font-semibold px-3 py-1.5 rounded-lg transition"
                                        @click="openEdit(u)"
                                    >
                                        Edit
                                    </button>
                                    ...
                                    <button
                                        type="button"
                                        class="bg-amber-50 hover:bg-amber-100 text-amber-700 text-xs font-semibold px-3 py-1.5 rounded-lg transition"
            ...
            <!-- akhir kartu tabel -->
            <p class="text-xs text-slate-400 mt-3">{{ users.length }} user.</p>
            <!-- jumlah user -->
        </div>
        <!-- akhir body -->
        ...
        >
            ...
            <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 border-t-4 border-brand-600" @click.stop>
                <!-- cegah tutup saat klik dalam -->
                <div class="flex items-center justify-between mb-5">
                    <!-- header modal -->
                    <h2 class="text-lg font-bold text-brand-800">{{ mode === 'create' ? 'Tambah User' : 'Edit User' }}</h2>
                    <!-- judul modal dinamis -->
                    <button type="button" class="text-slate-400 hover:text-slate-600 text-xl leading-none" @click="open = false">
                        &times;
                    </button>
                </div>
                <!-- akhir header modal -->
                ...
                <form class="space-y-3 text-sm" @submit.prevent="submit">
                    ...
                    <label class="block font-medium text-slate-600">
                        <!-- field password -->
                        <span>{{ mode === 'create' ? 'Password' : 'Password (kosongkan bila tidak diubah)' }}</span>
                        <!-- teks label dinamis -->
                        <div class="relative mt-1">
                            <!-- bungkus input + tombol mata -->
                    ...
                    <div class="flex justify-end gap-2 pt-2">
                        ...
                        <button
                            ...
                            class="px-5 py-2 rounded-xl bg-brand-600 hover:bg-brand-700 text-white font-semibold transition"
                        >
                            Simpan
                        </button>
                    </div>
